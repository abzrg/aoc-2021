...
that indicates the antenna's signal strength by displaying 0-50
<span style="color: #FFFF66;">stars</span>.

Your instincts tell you that in order to save Christmas, you'll need to get all
<span style="color: #FFFF66;">fifty stars</span> by December 25th.

Collect stars by solving puzzles. Two puzzles will be made available on each day
in the Advent calendar; the second puzzle is unlocked when you complete the
first. Each puzzle grants <span style="color: #FFFF66;">one star</span>. Good luck!
